...
namespace QuanLyBanHang
{
    public partial class frmKhachHang : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            string chuoi1 = "";
            int chuoi2 = 0;
            chuoi1 = Convert.ToString(Functions.GetFieldValues("SELECT TOP 1 MaKH FROM tblKhachHang order by MaKH desc"));
            chuoi2 = Convert.ToInt32(chuoi1.Remove(0, 2));
            if (chuoi2 + 1 < 10)
            {
                txtMaKH.Text = "KHH00" + (chuoi2 + 1).ToString();
            }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "UPDATE tblKhachHang SET TenKH=N'" + txtTenKH.Text.Trim().ToString() + "', GioiTinhKH='" + txtGioiTinh.Text.ToString() +
                "', SDTKH='" + txtDienThoai.Text.ToString() +
                "', EmailKH='" + txtEmail.Text.ToString() +
                "',DiaChiKH=N'" + txtDiaChi.Text.Trim().ToString() + "', NgayTaoKH='" + dtpNgayTao.Value +
        ...
        private void dgvKhachHang_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dtpNgayTao.Value = (DateTime)dgvKhachHang.CurrentRow.Cells["NgayTaoKH"].Value;
            txtMaKH.Enabled = true;
            txtTenKH.Enabled = true;
            txtGioiTinh.Enabled = true;
            txtDienThoai.Enabled = true;
